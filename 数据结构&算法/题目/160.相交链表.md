- **Metadata**
	- Link:  [相交链表](https://leetcode.cn/problems/intersection-of-two-linked-lists/description/ "https://leetcode.cn/problems/intersection-of-two-linked-lists/description/")
	- Tags :  [[链表]]、[[双指针]]
	- Difficulty：Easy
	- Date : 2023-08-11
---
...
var getIntersectionNode = function (headA, headB) {
    ...
    // 终止条件：存在相交结点或者 p1 和 p2 同时指向 null
    while (p1 !== p2) {
